...
public class PremierLeagueManager {
    ...
    public void displayMenu() {
        ...
        while(true) {
            ...
            System.out.println("1. Create new team and add it to league (press 1)");
            System.out.println("2. Delete existing team from league (press 2)");
            System.out.println("3. Display Statistics for team (press 3)");
            System.out.println("4. Display the Premier League Table (press 4)");
            System.out.println("5. Add a Played Match (press 5)");
            System.out.println("6. Display Calendar and Find Match (press 6)");
            System.out.println("-----------------------------------------------");
            String line = scanner.nextLine();
            System.out.println("You choose " + line + " menu.");
            System.out.println();
            int command = 0;
            try {
